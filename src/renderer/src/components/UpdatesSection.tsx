    ...
    <div>
        ...
        <div style={{ display: 'flex', gap: 8, flexShrink: 0, alignItems: 'center' }}>
          {pending && (
            <PixelButton
              ...
              title={`v${pending} のインストーラーをダウンロードして、アプリを手動で入れ替えます`}
            >
              手動でダウンロード
            </PixelButton>
          )}
      ...
      {manualStarted && (
        <div style={{
          ...
          <b>v{manualStarted} をブラウザでダウンロード中です。</b> ダウンロード完了後、このアプリを終了して
          新しいバージョンを上書きインストールし、起動して同じプロジェクトを選択してください。{steps.os}の場合:
