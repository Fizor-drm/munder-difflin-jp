    ...
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12, padding: 14 }}>
            ...
            {pending && (
              <>
                ...
                <span style={{ fontFamily: MONO, fontSize: 11, color: 'var(--cth-ink-700)' }}>
                  v{pending} がリリースされました
                </span>
                <PixelButton variant="primary" size="sm" onClick={downloadManually}
                  title="インストーラーをダウンロードして自分でアプリを置き換えます。自動アップデートは下の「アップデート」にあります。">
                  v{pending} をダウンロード
                </PixelButton>
              </>
            )}
        ...
        <div style={{
          ...
          }}>v0.5.0でMunder Difflin Proが登場。</div>
          <div style={{ marginTop: 6, fontSize: 12.5, lineHeight: 1.5, color: 'var(--cth-ink-700)', maxWidth: '64ch' }}>
            <b style={{ color: INK }}>Communityは無料のまま、オープンなまま、アップデートも続きます。</b>{' '}
            Proは新機能と連携を同梱して登場し、年間を通じて追加されていきます。コーディングエージェントと
            エージェントハーネスのポテンシャルを最大限引き出したいパワーユーザーのために、
            Communityより常に先を行くエディションです。Proのロードマップにはモバイルアプリも含まれます。
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 200 }}>
            <div style={{ fontFamily: MONO, fontSize: 12.5, fontWeight: 600 }}>Founders&rsquo; Wallに登録済みですか？</div>
            <div style={{ fontSize: 12, lineHeight: 1.45, opacity: 0.85, marginTop: 2 }}>
              Munder Difflin Proが1ヶ月無料、その後年間プランが50%オフ。Wall登録先着100名様限定。
            </div>
          </div>
        ...
        <div style={{
          ...
          <PixelButton variant="secondary" size="sm" onClick={showReleaseNotes}>
            <span title="最後に案内されたアップデートのリリースノートを表示します"
